...
"		Serhat Teker <serhat.teker@gmail.com>
...
"
" - 'False', 'None', and 'True' changed to custome statement
syn keyword pythonStatement	class nextgroup=pythonClass skipwhite
syn keyword pythonStatement	def nextgroup=pythonFunction skipwhite

syn keyword pythonStaCust	False, None, True
...
syn match pythonStatement   "\<from\>" display
...
syn match  pythonClassParameters "[^,]*" contained contains=pythonExtraOperator,pythonBuiltin,,pythonConstantpythonStatement,pythonNumber,pythonString,pythonBrackets skipwhite
...
syn region pythonFunctionVars start="(" end=")" contained contains=pythonFunctionParameters
...
syn match   pythonComment	"#.*$" contains=pythonTodo,pythonBug,@Spell
syn keyword pythonTodo		FIXME NOTE NOTES TODO XXX contained
syn keyword pythonBug		ERROR BUG contained
...
if !exists("python_no_builtin_highlight")
  ...
  syn keyword pythonStaCust	False True None
...
if (has("nvim"))
  ...
  " HiLink pythonFunctionVars	  Constant
  " HiLink pythonClassVars	  Constant
...
"   HiLink pythonParameters       Number
" endif
" }}}
